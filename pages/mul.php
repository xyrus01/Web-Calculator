...
/* HEADER */
    ...
    <title>Web Calculator | Multiplication</title>
</head>
<body>
<!------------ section: HEADER -------------->
    <div id="header">
        <div id="header_margin">
            ...
            <div id="selection">
                ...
                <a href="mul.php">
                    <p style="color: #E05153;">Multiply</p>
                </a>
                <a href="div.php">
                    <p>Divide</p>
                </a>
            ...
            <div id="form_section">
                <div class="container">
                    <div id="headings">
                        ...
                        <p text-align: justify;>Scale a number and have your product.</p>
                    </div>
    ...
    <!------------ section: PHP PROCESS -------------->
                    <div id="input_area">
                        <form action="" method="POST">
                            ...
                            <input id="compute" type="submit" name="compute" value="Compute Product">
                        </form>
                    </div>
    <!-- CODE HERE -->
                    <?php
