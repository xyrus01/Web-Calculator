...
/* HEADER */
    ...
    <title>Web Calculator | Division</title>
</head>
<body>
<!------------ section: HEADER -------------->
    <div id="header">
    ...
    <div id="form">
        <div id="form_container">
            <div id="form_section">
                <div class="container">
                    <div id="headings">
                        <h2>Quotient Calculator</h2>
                        <p text-align: justify;>Split a number into parts and get its quotient.</p>
                    </div>
    ...
    <!------------ section: PHP PROCESS -------------->
                    <div id="input_area">
                        <form action="" method="POST">
                            ...
                            <input id="compute" type="submit" name="compute" value="Compute Quotient">
                        </form>
                    </div>
    <!-- CODE HERE -->
                    <?php
